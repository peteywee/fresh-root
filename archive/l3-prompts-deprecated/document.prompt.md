...
agent: "agent" description: "Generate or update documentation (JSDoc, README, ADRs, API docs)"
tools: \[ "edit", "search", "firecrawl/firecrawl-mcp-server/_", "github/github-mcp-server/_",
"usages", "problems", "changes", "testFailure", "fetch",
