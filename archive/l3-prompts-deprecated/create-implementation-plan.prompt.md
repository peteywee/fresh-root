...
the current state of the plan. The status can be one of the following (status\_color in brackets):
...
1.0, Date] date\_created: \[YYYY-MM-DD] last\_updated: \[Optional: YYYY-MM-DD] owner: \[Optional:
