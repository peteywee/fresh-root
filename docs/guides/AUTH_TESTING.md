...
- qa-engineers
related-docs:
- MAGIC\_LINK\_AUTH.md
- ../standards/TEST\_PATTERNS.md
...
2. You'll see success animation ✓
...
1. Wait for countdown (or open DevTools console and fast-forward time)
2. After 60s, button enables
3. Click "Resend link"
4. ✓ Link sent again, countdown resets
```
...
1. Press Enter when button focused
   ✓ Button activates (same as click)
1. On email entry form:
   ✓ Email field focused
   ✓ Tab to error text (if invalid)
   ✓ Tab to Submit button
   ✓ Enter submits form
1. Press Escape (if applicable)
