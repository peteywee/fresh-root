...
### 7. **guides/crewops/08_BATCH_TEAMS.md** (NEW) 🧩 PARALLEL TEAMS

**For**: Batch execution with specialized teams\\

- Team scopes and handoff contracts
- Parallel scheduling template
