...
audience:
  ...
  - architects
related-docs:
  - SDK\_FACTORY\_COMPREHENSIVE\_GUIDE.md
  - ../guides/FIREBASE.md
...
title: Firebase SDK v12 Typing Modernization Strategy date: 2025-12-02
...
**Current State:** 379 lint errors in apps/web (327 errors + 52 warnings) **Root Cause:** Firebase
SDK v12 returns `any` typed values from APIs **Strategy:** Pragmatic three-phase approach to
modernize Firebase usage without breaking functionality
