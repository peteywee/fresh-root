...
title: "[ARCHIVED] Landing Page Redesign Brief for UI/UX Agent"
description: "Archived design brief for the Fresh Schedules landing page redesign."
keywords:
  - archive
  - design-brief
  - landing-page
...
--schedule-green: Data positives /* Success states */ --schedule-rose: Data negatives
  /* Alert states */;
```
