...
title: "[ARCHIVED] Brand Kit Implementation & Testing Plan"
description: "Archived implementation and testing plan for auth flows and brand rollout."
keywords:
   - archive
   - implementation
   - testing
...
1. **Fix CORS Warning** - Add `allowedDevOrigins` to next.config to suppress dev cross-origin
   warning
...
5. **Apply Brand Kit** - Use existing design tokens + UI/UX agent to professionally design landing
   page
...
1. Enhance e2e tests (Task 3)

### Phase 3: Brand Implementation (45 min)

1. Redesign landing page with brand kit (Task 5)
...
Google OAuth is preserved in refactored login page and should work without issues. The button is
part of a separate FirebaseUI instance (not removed).

---

**Next Step**: Start with Phase 1 (CORS fix + Google verification) then move to comprehensive e2e
testing and brand implementation.
