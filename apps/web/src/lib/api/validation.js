...
export class ValidationError extends Error {
    fields;
    statusCode;
    constructor(fields, statusCode = 422) {
 ...
 */
function zodErrorToFieldErrors(error) {
    const fieldErrors = {};
...
export async function validateRequest(request, schema) {
    ...
    try {
        ...
        if (textErr instanceof ValidationError)
            throw textErr;
