...
export function loadServerEnv() {
    ...
    if (env.NODE_ENV === "production") {
        if (!env.GOOGLE_APPLICATION_CREDENTIALS && !env.GOOGLE_APPLICATION_CREDENTIALS_JSON) {
            console.error("[env.server] Production requires GOOGLE_APPLICATION_CREDENTIALS or GOOGLE_APPLICATION_CREDENTIALS_JSON");
 ...
 */
export function useEmulators(env) {
 ...
 */
export function getFirebaseCredentials(env) {
