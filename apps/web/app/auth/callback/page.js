...
export default function AuthCallbackPage() {
    ...
    return (_jsx("div", { className: "flex min-h-screen items-center justify-center p-6", children: _jsxs("div", { className: "w-full max-w-md text-center", children: [_jsx("h1", { className: "mb-4 text-2xl font-semibold", children: "Signing you in\u2026" }), _jsx("p", { className: "text-gray-500", children: "Completing authentication. You\u2019ll be redirected shortly." }), status === "error" && (_jsx("p", { className: "mt-4 text-red-600", children: "Something went wrong. Please try again from the login page." }))] }) }));
}
