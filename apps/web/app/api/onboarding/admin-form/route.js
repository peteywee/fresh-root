...
import { CreateAdminResponsibilityFormSchema, } from "@fresh-schedules/types";
 ...
 */
export async function adminFormHandler(req, injectedAdminDb = importedAdminDb) {
    let body;
    try {
        body = await req.json();
    }
...
export const POST = async (req, _ctx) => {
    return await adminFormHandler(req);
};
