...
export async function bootstrapSessionHandler(req, injectedAdminDb) {
...
export const GET = withSecurity(async (req) => bootstrapSessionHandler(req, importedAdminDb), { requireAuth: true });
export const POST = withSecurity(async (req) => bootstrapSessionHandler(req, importedAdminDb), { requireAuth: true });
