...
export const PATCH = withSecurity(requireOrgMembership(requireRole("scheduler")(async (request, context) => {
    try {
        const { params } = context;
        const { id } = params;
...
export const DELETE = withSecurity(requireOrgMembership(requireRole("admin")(async (request, context) => {
    try {
        const { params } = context;
        const { id } = params;
