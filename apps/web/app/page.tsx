    ...
    <div className="min-h-screen flex flex-col bg-background text-foreground overflow-hidden bg-noise">
      <header className="px-6 py-5 flex items-center justify-between sticky top-0 z-50 bg-background/90 backdrop-blur-md border-b border-border">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/login">
            <Button size="sm" className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-sm">
              Get Started
            </Button>
          </Link>
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
              <Link href="/login" className="w-full sm:w-auto">
                <Button size="lg" className="w-full h-14 px-10 text-lg bg-primary text-primary-foreground hover:bg-primary/90 rounded-sm font-bold shadow-[0_0_15px_-3px_rgba(212,175,55,0.3)]">
                  Start Scheduling
