...
2. **BRANCH_STRATEGY_QUICK_REFERENCE.md** (310 lines)
...
3. **SR_DEV_DIRECTIVE.md** (465 lines)
...
4. **validate-branch-files.js** (400+ lines)
...
- **Feature Branches**: feature/*, fix/*, chore/*, refactor/*
