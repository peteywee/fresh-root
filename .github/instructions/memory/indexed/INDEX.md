...
description: "Brief domain/lesson responsibility" applyTo: ["glob/patterns/**"] tags: ["tag1",
"tag2", "tag3"] type: "pattern|gotcha|best-practice|automation|workflow" domain: "domain-name"
priority: 1-3 created: "YYYY-MM-DD" updated: "YYYY-MM-DD" relatedDomains: ["related-domain"]
