...
description: "Dynamic personality switching and orchestration patterns for complex AI agent workflows"
...
Patterns for managing complex AI agent workflows through dynamic personality switching and error protocol compliance.

## Dynamic Personality Switching

**Critical principle**: Different problem types require different cognitive approaches. Agent must dynamically adopt appropriate personas:
...
**Trigger**: When same error pattern occurs 3+ times
**Required workflow**:
...
**Example**: ZodType compatibility crisis → Error Protocol → Architectural fix → 50+ routes unblocked
