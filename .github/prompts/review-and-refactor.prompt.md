...
1. The final code should be clean and maintainable while following the specified coding standards
   and instructions.
1. Do not split up the code, keep the existing files intact.
2. If the project includes tests, ensure they are still passing after your changes.
