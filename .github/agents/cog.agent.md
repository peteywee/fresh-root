...
model: local-cli
description: "Repository-aware agent that verifies doc & test parity, scans for RBAC and rule violations, detects cross-layer pattern risks, and proposes minimal remediations. For LAW-level issues the agent raises an issue and halts remediation."
target: repo
tools:
