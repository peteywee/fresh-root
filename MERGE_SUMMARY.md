...
## Overview
This document summarizes the work done to consolidate feature branches into the `dev` branch as requested.
...
**Task**: Merge all feature branches to dev and close PRs
