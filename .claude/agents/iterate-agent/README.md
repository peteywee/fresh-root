...
The Iterate Agent orchestrates complex implementations by breaking them into task graphs, assigning
specialized agents, and executing with validation and review.
...
Input: User objective statement Output: Structured breakdown with scope, constraints, success
criteria
